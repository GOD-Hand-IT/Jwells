  ...
  return (
    <div className="contain">
      ...
      <nav class="flex items-center gap-x-1" aria-label="Pagination">
        ...
        <div class="flex items-center gap-x-1">
          {[...Array(totalPages)].map((_, index) => (
            <button
              ...
              type="button"
              class={`min-h-[38px] min-w-[38px] flex justify-center items-center ${currentPage === index + 1 ? 'bg-gray-200 dark:bg-neutral-600' : 'hover:bg-gray-100 dark:hover:bg-white/10'
        ...
        <button type="button" class="min-h-[38px] min-w-[38px] py-2 px-2.5 inline-flex justify-center items-center gap-x-1.5 text-sm rounded-lg text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-white/10 dark:focus:bg-white/10" aria-label="Next" onClick={handleNextPage} disabled={currentPage === totalPages}>
          <span>Next</span>
          <svg class="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
